          ...
          collapseDetail={
            <>
              <div className="mb-4">
                ...
                ซึ่งพระมหากษัตริย์ทรงแต่งตั้งตามคำแนะนำของวุฒิสภา ประกอบด้วย
              </div>
              <CustomImg
          ...
          collapseDetail={
            <>
              ...
              <span className="font-bold">
                ...
                ที่พ้นจากตำแหน่ง เพราะครบกำหนดวาระแล้วปฏิบัติหน้าที่ต่อไป
              </span>
              จนกว่าจะมี พ.ร.ป.
              ว่าด้วยวิธีพิจารณาของศาลรัฐธรรมนูญที่ออกตามรัฐธรรมนูญ 2560
              ใช้บังคับ
            </>
          }
        ...
        <SituationDetail
          ...
          collapseDetail={
            <>
              <div className="mb-4 font-bold">
                ...
                ซึ่งพระมหากษัตริย์ทรงแต่งตั้งจากมติของวุฒิสภา ประกอบด้วย
              </div>
              <CustomImg
          ...
          body={
            <>
              ...
              และพรรคร่วมฝ่ายค้าน ที่คำวินิจฉัยเป็นผลบวกเพียงแค่ 20% (1 ใน 5
              คำวินิจฉัย)
            </>
          }
        />
        ...
        <SituationDetail
          ...
          body={
            <>
              ...
              ในขณะที่สร้างผลลัพธ์ด้านผลลบต่อฝ่ายคู่แข่งทางการเมืองอยู่หลายครั้ง
              เช่น สิ้นสุดสถานะการเป็น สส. ของธนาธร จึงรุ่งเรืองกิจ
              จากพรรคอนาคตใหม่ และวินิจฉัยยุบพรรคอนาคตใหม่
            </>
          }
        />
      </SectionBox>
